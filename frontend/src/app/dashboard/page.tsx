        ...
        <div className="flex h-screen bg-[#050505] text-white">
            ...
            <div className="w-64 border-r border-gray-900 flex flex-col p-4 hidden md:flex">
                ...
                <button
                    ...
                    className="flex items-center gap-2 w-full p-3 rounded-xl bg-gray-900 border border-gray-800 text-sm font-medium hover:bg-gray-800 transition-colors mb-8"
                >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full max-w-6xl animate-fade-in">
                            ...
                            <div className="flex flex-col gap-8">
                                ...
                                <div className="flex gap-4">
                                    <button className="flex-1 bg-white text-black py-4 rounded-2xl font-bold hover:bg-gray-200 transition-colors">
                                        Download MP4
                                    </button>
                                    <button className="flex-1 bg-gray-900 text-white py-4 rounded-2xl font-bold border border-gray-800 hover:bg-gray-800 transition-colors">
                                        Edit Script
                                    </button>
                                </div>
                            </div>
