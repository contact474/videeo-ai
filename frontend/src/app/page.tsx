...
import { Play, Mic, Video, FileText, Globe, Layers, CheckCircle, ChevronRight } from 'lucide-react'
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/dashboard" className="w-[220px] bg-white text-black py-4 rounded-xl font-bold text-lg hover:bg-yellow-400 transition-all active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.1)]">
              Start Creating Free
            </Link>
